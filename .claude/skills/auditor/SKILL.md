...
> **참조**: `@.agent/workflows/auditor.md`, `@.claude/skills/code-review/SKILL.md`
...
5. ✅ 검증 통과 → /smart-commit으로 커밋/PR 진행
```
...
```bash
# 1. API 빌드
cd /home/ubuntu/ops/ops-api && npm run build

# 2. Web 빌드
cd /home/ubuntu/ops/ops-web && npm run build
